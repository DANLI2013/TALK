	...
	<body>
		<div id="gxz">
			...
			<spring:bind path="userInfo.password">
				<li>
					<label>密码<b class="nan">*</b></label>
					<input id="firstPassword" class="xfy_text_before" name="${status.expression}" type="password" validateType="lengthRange-1-10" value="${status.value}"/>
					<span class="hlight">${status.errorMessage}</span>
				</li>
			</spring:bind>
				<li>
					<label>再输入一次密码<b class="nan">*</b></label>
					<input class="xfy_text_before" type="password" validateType="equals-firstPassword|lengthRange-1-10"/>
				</li>
